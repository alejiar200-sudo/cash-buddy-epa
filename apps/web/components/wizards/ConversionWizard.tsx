...
export function ConversionWizard({ open, onOpenChange, date }: Props) {
  ...
  async function submit() {
    ...
    await addMovement(date, { category: 9, type: "egreso", medium: "cash", amount, workerId, description: `Conv: ${who}` });
    await addMovement(date, { category: 10, type: "ingreso", medium: "bank", amount, workerId, description: `Conv: ${who}` });
