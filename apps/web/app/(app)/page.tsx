    ...
    <div className="space-y-6">
      ...
      <section className="glass-strong rounded-3xl p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/domiciliarios" className="text-sm text-primary font-bold hover:underline">Ver todos →</Link>
        </div>
...
function CourierChip({ s }: { s: ReturnType<typeof courierStatusForDay> & { worker: { id: string; name: string; color: string } } }) {
  ...
  return (
    <Link href="/domiciliarios" className={`flex items-center gap-2 px-3 py-2 rounded-2xl text-sm font-bold transition hover:scale-105 ${map.cls}`}>
      {map.icon}
