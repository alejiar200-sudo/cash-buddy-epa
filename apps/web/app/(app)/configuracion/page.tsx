...
export default function SettingsPage() {
  ...
  async function save() {
    await updateSettings({ companyName: name, initialCash: cash, initialBank: bank, commissionPercent: pct });
  ...
  return (
    <div className="space-y-5 max-w-2xl">
      ...
      <div className="glass-strong rounded-3xl p-6 border border-danger/30">
        ...
        <p className="text-sm text-muted-foreground mb-4">Esto borra absolutamente toda la información: días, movimientos, arqueos.</p>
        {confirm === 0 && (
